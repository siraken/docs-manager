  ...
  <div>
    ...
    <div class="row flex-row">
        <div class="col-h">
            ...
            <div class="form-row">
                <div class="form-group col-10">
                  <input type="text" name="responsible" class="input" placeholder="担当者" value="<?= $header['Invoice']['responsible']; ?>">
                </div>
                <div class="form-group col-2">
                  <input type="text" name="honor_title" class="input" value="<?= $header['Invoice']['honor_title']; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-6">
                ...
                <input type="text" id="issued_date" name="issued_date" class="input" value="<?= date('Y/m/d', strtotime($header['Invoice']['issued_date']));?>">
              </div>
              <div class="form-group col-6">
                <label>お支払い期限</label>
                <input type="text" id="exp_date" name="exp_date" class="input" value="<?= !empty($header['Invoice']['exp_date']) ? date('Y/m/d', strtotime($header['Invoice']['exp_date'])) : '';?>">
              </div>
            </div>

            <div class="form-group">
                <label>請求番号 <span class="required-badge">必須</span></label>
                <input type="text" name="invoice_no" class="input readonly" value="<?= $header['Invoice']['invoice_no'];?>" readonly>
            </div>
            <div class="form-group">
                <label>件名</label>
        ...
        <div class="col-h">
          ...
          <a href="../../company" target="_blank" class="link">自社情報を変更する</a>
        </div>
    </div>
      ...
      <table class="table" id="table">
        ...
        <tbody class="main_tbody" id="sortable">
          ...
          <tr class="sortable-tr">
            ...
            <td class="item-cell">
              <input type="text" name="item_name[]" class="table-input ti-name" value="<?= $detail['InvoiceDetail']['item_name'];?>">
              <div class="items_box">
                <ul class="items">
...
window.onload = function() {
  addUniqueId();
  $('#customer').val('<?= $header['Invoice']['destination'];?>');
}
/* 列を追加 */
function addRow() {
...
let app = new Vue({
  el: '#app',
  data: {
    titleCount: '<?= $header['Invoice']['title'];?>',
    remarksCount: '<?= $header['Invoice']['remarks'];?>',
  },
  methods: {
