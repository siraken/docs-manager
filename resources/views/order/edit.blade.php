...
<a href="javascript:history.back();" class="btn btn-primary"><i class="fa fa-reply"></i> 戻る</a>
<a class="btn btn-primary" id="add_button"><i class="fa fa-floppy-o"></i> 保存する</a>

    <div class="row flex-row">
        <div class="col-h">
            <p class="title">見積情報</p>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-10">
                  <input type="text" name="responsible" class="input" placeholder="担当者" value="<?= $header['Estimate']['responsible']; ?>">
                </div>
                <div class="form-group col-2">
                  <input type="text" name="honor_title" class="input" value="<?= $header['Estimate']['honor_title']; ?>">
                </div>
            </div>

            <div class="form-row">
              <div class="form-group col-6">
                <label>発行日 <span class="required-badge">必須</span></label>
                <input type="text" id="issued_date" name="issued_date" class="input" value="<?= date('Y/m/d', strtotime($header['Estimate']['issued_date']));?>">
              </div>
              <div class="form-group col-6">
                <label>有効期限</label>
                <input type="text" id="exp_date" name="exp_date" class="input" value="<?= !empty($header['Estimate']['exp_date']) ? date('Y/m/d', strtotime($header['Estimate']['exp_date'])) : '';?>">
              </div>
            </div>

            <div class="form-group">
                <label>見積番号 <span class="required-badge">必須</span></label>
                <input type="text" name="estimate_no" class="input readonly" value="<?= $header['Estimate']['estimate_no'];?>" readonly>
            </div>
            <div class="form-group">
                <label>件名</label>
      ...
      <table class="table" id="table">
        ...
        <tbody class="main_tbody" id="sortable">
          ...
          <tr class="sortable-tr">
            ...
            <td><input type="text" name="qty[]" id="qty1" class="table-input ti-qty text-right" value="<?= $detail['EstimateDetail']['qty'];?>"></td>
            <td><input type="text" name="unit[]" class="table-input ti-unit text-center" placeholder="単位"  value="<?= $detail['EstimateDetail']['unit'];?>"></td>
            <td><input type="text" name="cost[]" id="cost1" class="table-input ti-cost text-right" value="<?= $detail['EstimateDetail']['cost'];?>"></td>
            <td>
            <?php
...
let app = new Vue({
  el: '#app',
  data: {
    titleCount: '<?= $header['Estimate']['title'];?>',
    remarksCount: '<?= $header['Estimate']['remarks'];?>',
  },
  methods: {
    fillRemarks: function() {
      remarks.value = '<?= $companyData['estimate_remarks'];?>';
    }
  }
})
</script>
