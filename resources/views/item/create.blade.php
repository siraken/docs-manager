    ...
    <div class="row">
      ...
      <div class="col-h">
        <div class="form-group">
          ...
          <input type="text" name="name" class="input mb-1">
        </div>
        <div class="form-group">
          <label>単位</label>
          <input type="text" name="unit" class="input w-50 mb-1" list="unit_list">
        ...
        <div class="form-group">
          <label>単価</label>
          <div class="flex">
            <input type="text" name="cost" class="input w-50"><label class="price">円</label>
          </div>
        </div>
        <div class="form-group">
          <label>税率</label>
